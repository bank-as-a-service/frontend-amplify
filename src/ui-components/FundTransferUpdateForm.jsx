...
export default function FundTransferUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = fundTransferRecord
      ? { ...initialValues, ...fundTransferRecord }
      : initialValues;
    setCreatedOn(cleanValues.createdOn);
    setStatus(cleanValues.status);
    setAmount(cleanValues.amount);
    setSourceAccountId(cleanValues.sourceAccountId);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            FundTransfer.copyOf(fundTransferRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "FundTransferUpdateForm")}
      {...rest}
    >
      <TextField
        label="Created on"
